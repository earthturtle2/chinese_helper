...
/** 家长代子女进入背诵：选课文后由孩子发声，或家长代读（识别可能不准，可手动改） */
export default function ParentRecitation() {
  ...
  const base = `/parent/children/${sid}/recitation`;
  ...
  return (
    <div className="page">
      <div className="page-header page-header-study">
        ...
        <h2>检查背诵（{childName || '…'}）</h2>
        <span className="hint-text">在课文中选一段再背诵；记录会记在孩子名下</span>
